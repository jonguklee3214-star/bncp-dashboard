    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "비고: 입력할 때 적은 비고도 목록에 그대로 보입니다.",
          "① 잘못 입력했다 (입력자): 그 기록의 '수정 요청' 버튼 → 이름과 사유만 적어 보냅니다. 값은 여기서 고치지 않습니다.",
          "② 관리자 확인: 오른쪽 위 🔒 → PIN 입력 → 📥 수정 요청. 두 가지 중 하나를 고릅니다. '승인(요청자가 수정)'은 잠금만 풀어 주고, '바로 수정'은 관리자가 그 자리에서 고칩니다.",
          "③ 승인 후 (입력자): 같은 기록에 초록색 '✏ 수정하기' 버튼이 생깁니다. 누르고 값을 고쳐 저장하면 끝입니다. PIN 필요 없습니다.",
          "④ 승인 1건 = 수정 1회입니다. 저장하면 버튼이 사라지고, 또 고치려면 다시 요청합니다.",
          "수정 흔적: 고친 기록에는 '✏ 수정됨' 표시가 붙습니다. 누르면 언제·누가·무엇을 왜 고쳤는지 나옵니다.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Remarks: the remarks you typed at entry are shown in the list.",
          "1. Wrong entry (entrant): press 'Request Edit' on that row and write your name and the reason only. You do not change values here.",
          "2. Admin review: top-right 🔒 → PIN → 📥 Edit Requests. Either 'Approve (requester edits)', which just unlocks the record, or 'Edit now', which lets the admin fix it on the spot.",
          "3. After approval (entrant): a green '✏ Edit' button appears on that record. Press it, fix the values, save. No PIN needed.",
          "4. One approval = one edit. After saving, the button disappears; request again if you need another change.",
          "Edit trace: an edited record shows '✏ Edited'. Press it to see when, who, what and why.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "মন্তব্য: এন্ট্রির সময় লেখা মন্তব্যও তালিকায় দেখা যায়।",
          "১. ভুল হলে (এন্ট্রিকারী): সেই সারির 'সম্পাদনার অনুরোধ' বোতামে নাম ও কারণ লিখে পাঠান। এখানে মান বদলাবেন না।",
          "২. অ্যাডমিন যাচাই: উপরে ডানে 🔒 → পিন → 📥 সম্পাদনার অনুরোধ। 'অনুমোদন (অনুরোধকারী ঠিক করবেন)' শুধু লক খুলে দেয়, আর 'এখনই সম্পাদনা' হলে অ্যাডমিন নিজেই ঠিক করেন।",
          "৩. অনুমোদনের পর (এন্ট্রিকারী): সেই রেকর্ডে সবুজ '✏ সম্পাদনা' বোতাম আসে। চেপে মান ঠিক করে সংরক্ষণ করুন। পিন লাগে না।",
          "৪. এক অনুমোদন = এক বার সম্পাদনা। সংরক্ষণের পর বোতাম চলে যায়; আবার দরকার হলে নতুন অনুরোধ করুন।",
          "সম্পাদনার চিহ্ন: সম্পাদিত রেকর্ডে '✏ সম্পাদিত' দেখায়। চাপলে কখন·কে·কী·কেন বদলেছে দেখা যায়।",
